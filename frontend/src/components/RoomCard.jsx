...
const RoomCard = ({
  ...
  return (
    ...
    <div  onClick={onJoinClick} className="border border-primary rounded-lg shadow-xl hover:shadow-none flex flex-col justify-between group cursor-pointer transition duration-300 ease-in-out">
      <div>
        <h3 className="text-primary bg-bgLight border-b border-primary font-semibold px-4 py-2 rounded-t-lg text-lg mb-3">
          {roomName}
        </h3>
        <div className="px-4 pb-4">
          ...
          <p className="flex items-center text-sm text-gray-600 mb-2 gap-2">
            ...
            <span className=" text-xs"><DateTimeFormatter dateString={createdAt}/></span>
          </p>
...
const RoomsGrid = ({ rooms, onJoinClick }) => {
  return (
